        ...
        return page_type2(
            ...
            [
                widget::button(lang.text(Msg::EraseConfirmReject))
                    .on_press(BBImagerMessage::CancelFlashRequest)
                    .style(widget::button::secondary),
                widget::button(lang.text(Msg::EraseConfirmAccept))
                    .on_press(BBImagerMessage::FlashStart)
...
fn dfu_instruction<'a>(title: &'a str, body: &'a str) -> Element<'a, BBImagerMessage> {
    widget::column![
