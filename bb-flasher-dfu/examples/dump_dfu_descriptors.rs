...
//!     cargo run -p bb-flasher-dfu --example dump_dfu_descriptors
//!
...
fn main() -> rusb::Result<()> {
    ...
    for device in devices.iter() {
        ...
        let is_t3 = descriptor.vendor_id() == bb_flasher_dfu::T3_DFU_VENDOR_ID
            && descriptor.product_id() == bb_flasher_dfu::T3_DFU_PRODUCT_ID;
