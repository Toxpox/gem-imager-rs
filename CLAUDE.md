...
`make help` lists all Makefile targets and tunable variables (`TARGET`, feature toggles like `UPDATER`, packaging vars). Packaging targets (`package-<triple>`) and installs live in the Makefile too.
